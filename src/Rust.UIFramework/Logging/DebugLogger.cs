...
public class DebugLogger
{
    ...
    /// <param name="name">Name of the field</param>
    /// <param name="value">Value of the field</param>
    public void AppendFieldEnum<T>(string name, T value) where T : unmanaged, Enum, IComparable, IFormattable, IConvertible => AppendField(name, EnumCache<T>.ToString(value));

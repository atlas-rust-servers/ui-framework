...
public readonly struct UiPosition(float xMin, float yMin, float xMax, float yMax) : IEquatable<UiPosition>
{
    ...
    public UiPosition Translate(in UiTranslate translate)
    {
...
#pragma warning restore EPS05
    ...
    public static UiPosition Parse(ReadOnlySpan<char> input, ReadOnlySpan<char> token = " ") => TryParse(input, out UiPosition result, token) ? result : throw FormatException.FailedParse<UiPosition>(input);

...
{
    private readonly Dictionary<PluginPlayerStore, IPlayerStore> _stores = [];
    private readonly Dictionary<PluginId, PlayerStoreData> _pluginData = [];

...
#pragma warning restore EPS05
    ...
    public static UiOffset Parse(ReadOnlySpan<char> input, ReadOnlySpan<char> token = " ") => TryParse(input, out UiOffset result, token) ? result : throw FormatException.FailedParse<UiOffset>(input);
